...
for ( let i = 0; i < 10; i++){
    ...
    const currentName = nomi[randomName][0].toUpperCase() + nomi[randomName].substring(1);
    const currentSurname = cognomi[randomSurname][0].toUpperCase() + nomi[randomSurname].substring(1);

    const currentGuest = currentName + " " + currentSurname;
